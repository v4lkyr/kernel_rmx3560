...
extern bool oplus_usbtemp_check_is_platpmic(struct oplus_chg_chip *chip);
...
int oplus_usbtemp_dischg_action(struct oplus_chg_chip *chip)
{
	...
	if (get_eng_version() == HIGH_TEMP_AGING) {
		...
		if(oplus_usbtemp_check_is_platpmic(chip) == true) {
			if(chip->chg_ops->set_dischg_enable != NULL) {
...
void oplus_usbtemp_recover_func(struct oplus_chg_chip *chip)
{
	...
	if (level == 1 && (chip->usb_status & USB_TEMP_HIGH)) {
...
static void oplus_usbtemp_recover_tbatt_temp(struct oplus_chg_chip *chip) {
	...
	if(usbtemp_debug & OPEN_LOG_BIT)
		chg_err("g_tbatt_temp:%d, tbatt_temp:%d\n", g_tbatt_temp, chip->tbatt_temp);
	chg_type = oplus_vooc_get_fast_chg_type();
	if ((chg_type == 19 || chg_type == 52 || chg_type == 69) && chip->usbtemp_change_gap) {/*20W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 65 || chg_type == 25 || chg_type == 41 || chg_type == 66
	 || chg_type == 67 || chg_type == 68 || chg_type == 70) && chip->usbtemp_change_gap) {/*30W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 73 || chg_type == 74 || chg_type == 97) && chip->usbtemp_change_gap) {/*33W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 17 || chg_type == 18 || chg_type == 33 || chg_type == 49 || chg_type == 51 || chg_type == 98) && chip->usbtemp_change_gap) {/*50W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 20 || chg_type == 53 || chg_type == 99 || chg_type == 110 || chg_type == 102) && chip->usbtemp_change_gap) {/*65W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 100 || chg_type == 54) && chip->usbtemp_change_gap) {/*66W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 108 || chg_type == 109) && chip->usbtemp_change_gap) {/*67W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 101 || chg_type == 75 || chg_type == 76 || chg_type == 77 || chg_type == 78) && chip->usbtemp_change_gap) {/*80W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
		chip->usbtemp_batttemp_recover_gap = 11;
	} else if ((chg_type == 105 || chg_type == 106 || chg_type == 107) && chip->usbtemp_change_gap) {/*100W*/
		chip->usbtemp_batttemp_gap = 19;
		chip->usbtemp_batttemp_current_gap = 17;
		chip->usbtemp_max_temp_thr = 65;
		chip->usbtemp_max_temp_diff = 10;
...
void oplus_update_usbtemp_current_status(struct oplus_chg_chip *chip)
{
	...
	/*chg_err("usb_temp_l= %d, usb_temp_r= %d, batt_temp = %d, sub_board_temp = %d, usbtemp_batttemp_gap = %d\n",
		chip->usb_temp_l, chip->usb_temp_r, g_tbatt_temp/10, chip->tbatt_temp/10, chip->usbtemp_batttemp_gap);*/
	...
	while (!kthread_should_stop()) {
		...
		if (g_tbatt_temp/10 <= USB_50C &&(((chip->usb_temp_l >= chip->usbtemp_max_temp_thr) && (chip->usb_temp_l < USB_100C))
			...
			if (count_r >= retry_cnt || count_l >= retry_cnt) {
				if (!IS_ERR_OR_NULL(chip->normalchg_gpio.dischg_enable) || (oplus_usbtemp_check_is_platpmic(chip) == true)) {
