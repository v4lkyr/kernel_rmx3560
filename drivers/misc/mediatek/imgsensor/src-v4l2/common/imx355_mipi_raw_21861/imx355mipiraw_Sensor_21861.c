...
#include "imx355_eeprom_21861.h"
#include "imx355_ana_gain_table_21861.h"
#include "imx355mipiraw_Sensor_21861.h"
...
#define imx355_table_write_cmos_sensor_21861(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)

/************************Modify Following Strings for Debug********************/
#define PFX "IMX355_camera_sensor_21861"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_21861,
...
kal_uint16 addr_data_pair_init_imx355_21861[] = {
    0x0106, 0x01,
    0x0136, 0x18,
    0x0137, 0x00,
    0x4348, 0x16,
...
{
    LOG_INF("E\n");
    imx355_table_write_cmos_sensor_21861(ctx, addr_data_pair_init_imx355_21861,
        sizeof(addr_data_pair_init_imx355_21861)/sizeof(kal_uint16));

    /*enable temperature sensor, TEMP_SEN_CTL:*/
    write_cmos_sensor(ctx, 0x0138, 0x01);
}    /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx355_21861[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, addr_data_pair_preview_imx355_21861,
    sizeof(addr_data_pair_preview_imx355_21861) / sizeof(kal_uint16));
    /* zvhdr_setting(ctx); */
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}                /*    preview_setting  */

kal_uint16 addr_data_pair_capture_imx355_21861[] = {
     0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void capture_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
    ...
    imx355_table_write_cmos_sensor_21861(ctx, addr_data_pair_capture_imx355_21861,
    sizeof(addr_data_pair_capture_imx355_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

kal_uint16 addr_data_pair_video_imx355_21861[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
    ...
    imx355_table_write_cmos_sensor_21861(ctx, addr_data_pair_video_imx355_21861,
    sizeof(addr_data_pair_video_imx355_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

kal_uint16 addr_data_pair_hs_video_imx355_21861[] = {
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
    0x0342, 0x07,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, addr_data_pair_hs_video_imx355_21861,
    sizeof(addr_data_pair_hs_video_imx355_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}
...
static kal_uint16 slim_video_setting_array_21861[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, slim_video_setting_array_21861,
        sizeof(slim_video_setting_array_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom1_setting_array_21861[] = {
    0x0112,0x0A,
    0x0113,0x0A,
    0x0114,0x03,
    0x0342,0x0E,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, custom1_setting_array_21861,
        sizeof(custom1_setting_array_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom2_setting_array_21861[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, custom2_setting_array_21861,
        sizeof(custom2_setting_array_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom3_setting_array_21861[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, custom3_setting_array_21861,
        sizeof(custom3_setting_array_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom4_setting_array_21861[] = {
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
    0x0342, 0x0E,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, custom4_setting_array_21861,
        sizeof(custom4_setting_array_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom5_setting_array_21861[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_21861(ctx, custom5_setting_array_21861,
        sizeof(custom5_setting_array_21861) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}
 ...
 *
 *************************************************************************/
static BYTE imx355_common_data_21861[OPLUS_CAMERA_COMMON_DATA_LENGTH] = { 0 };
static void read_module_data(struct subdrv_ctx *ctx)
{
	kal_uint16 idx = 0;
	read_imx355_eeprom_info_21861(ctx, EEPROM_META_MODULE_ID,
				&(imx355_common_data_21861[0]), 2);
	imgsensor_info.module_id = (kal_uint16)(imx355_common_data_21861[1] << 8) |
				   imx355_common_data_21861[0];
	read_imx355_eeprom_info_21861(ctx, EEPROM_META_SENSOR_ID,
				&(imx355_common_data_21861[2]), 2);
	read_imx355_eeprom_info_21861(ctx, EEPROM_META_LENS_ID,
				&(imx355_common_data_21861[4]), 2);
	read_imx355_eeprom_info_21861(ctx, EEPROM_META_VCM_ID,
				&(imx355_common_data_21861[6]), 2);
	read_imx355_eeprom_info_21861(ctx, EEPROM_META_MODULE_SN,
				&(imx355_common_data_21861[8]), 17);

	for (idx = 0; idx < 30; idx = idx + 4)
		printk(KERN_ERR "cam data: %02x %02x %02x %02x\n",
		       imx355_common_data_21861[idx], imx355_common_data_21861[idx + 1],
		       imx355_common_data_21861[idx + 2],
		       imx355_common_data_21861[idx + 3]);
}
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx355_ana_gain_table_21861);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx355_ana_gain_table_21861,
            sizeof(imx355_ana_gain_table_21861));
        }
        break;
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, imx355_common_data_21861,
    ...
    case SENSOR_FEATURE_GET_PDAF_DATA:
        ...
        imx355_read_DCC_21861(ctx, (kal_uint16) (*feature_data),
...
const struct subdrv_entry imx355_mipi_raw_21861_entry = {
    .name = "imx355_mipi_raw_21861",
    .id = IMX355_SENSOR_ID_21861,
    .pw_seq = pw_seq,
