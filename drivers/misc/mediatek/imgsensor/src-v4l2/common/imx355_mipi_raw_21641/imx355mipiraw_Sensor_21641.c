...
static kal_uint32 set_test_pattern_mode(struct subdrv_ctx *ctx, kal_uint8 modes, struct mtk_test_pattern_data *pTestpatterndata)
{
    ...
    if (modes) {
        ...
        if (modes == 1 && (pTestpatterndata != NULL)) { //Solid Color
            Color_R = (pTestpatterndata->Channel_R >> 16) & 0xFFFF;
            Color_Gr = (pTestpatterndata->Channel_Gr >> 16) & 0xFFFF;
            Color_B = (pTestpatterndata->Channel_B >> 16) & 0xFFFF;
            Color_Gb = (pTestpatterndata->Channel_Gb >> 16) & 0xFFFF;
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
    ...
    case SENSOR_FEATURE_SET_TEST_PATTERN:
        set_test_pattern_mode(ctx, (UINT8)*feature_data, (struct mtk_test_pattern_data *)feature_data+1);
        break;
