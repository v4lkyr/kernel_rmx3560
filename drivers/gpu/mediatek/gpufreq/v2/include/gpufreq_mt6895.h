...
#ifndef __GPUFREQ_MT6895_H__
#define __GPUFREQ_MT6895_H__
 ...
 * Shader Core Setting
 **************************************************/
#define MFG3_SHADER_STACK0              (T0C0 | T0C1)   /* MFG7, MFG9 */
#define MFG4_SHADER_STACK1              (T1C0)          /* MFG8 */
#define MFG5_SHADER_STACK2              (T4C0 | T4C1)   /* MFG10, MFG12 */
#define MFG6_SHADER_STACK4              (T5C0)          /* MFG11 */
 ...
 **************************************************/
#define STACK_ACT_REF_POWER             (2051)          /* mW  */
...
#define GPUFREQ_BATT_OC_FREQ            (470000)
#define GPUFREQ_BATT_PERCENT_IDX        (0)
#define GPUFREQ_LOW_BATT_FREQ           (470000)
...
struct gpufreq_mtcmos_info {
	...
	struct device *mfg5_dev;  /* ST4      */
	struct device *mfg6_dev;  /* ST5      */
	struct device *mfg7_dev;  /* ST0T0    */
	struct device *mfg8_dev;  /* ST1T0    */
	struct device *mfg9_dev;  /* ST0T1    */
	struct device *mfg10_dev; /* ST4T0    */
	struct device *mfg11_dev; /* ST5T0    */
	struct device *mfg12_dev; /* ST4T1    */
...
struct gpufreq_opp_info g_default_stack[] = {
	GPUOP(860000, 75000, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  0 sign off */
	GPUOP(852000, 74375, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  1 */
	GPUOP(845000, 73750, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  2 */
	GPUOP(837000, 73125, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  3 */
	GPUOP(830000, 72500, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  4 */
	GPUOP(822000, 71875, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  5 */
	GPUOP(815000, 71250, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  6 */
	GPUOP(807000, 70625, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  7 */
	GPUOP(800000, 70000, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  8 sign off */
	GPUOP(773000, 69375, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /*  9 */
	GPUOP(747000, 68750, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 10 */
	GPUOP(721000, 68125, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 11 */
	GPUOP(695000, 67500, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 12 */
	GPUOP(668000, 66875, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 13 */
	GPUOP(642000, 66250, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 14 */
	GPUOP(616000, 65625, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 15 */
	GPUOP(590000, 65000, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 16 sign off */
	GPUOP(572000, 64375, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 17 */
	GPUOP(555000, 63750, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 18 */
	GPUOP(538000, 63125, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 19 */
	GPUOP(521000, 62500, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 20 */
	GPUOP(504000, 61875, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 21 */
	GPUOP(487000, 61250, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 22 */
	GPUOP(470000, 60625, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 23 */
	GPUOP(453000, 60000, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 24 */
	GPUOP(436000, 59375, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 25 */
	GPUOP(419000, 58750, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 26 */
	GPUOP(402000, 58125, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 27 */
	GPUOP(385000, 57500, VSRAM_LEVEL_0, POSDIV_POWER_4, 0, 0), /* 28 */
	GPUOP(368000, 56875, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 29 */
	GPUOP(351000, 56250, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 30 */
	GPUOP(334000, 55625, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 31 */
	GPUOP(317000, 55000, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 32 sign off */
	GPUOP(304000, 54375, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 33 */
	GPUOP(292000, 53750, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 34 */
	GPUOP(280000, 53125, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 35 */
	GPUOP(268000, 52500, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 36 */
	GPUOP(255000, 51875, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 37 */
	GPUOP(243000, 51250, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 38 */
	GPUOP(231000, 50625, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 39 */
	GPUOP(219000, 50000, VSRAM_LEVEL_0, POSDIV_POWER_8, 0, 0), /* 40 sign off */
};
...
//TODO rebecca wait for Project team's data
/* MCL50 flavor load */
